...
const SingupBasic = () => {
    ...
    useEffect(() => {
		...
		if (!source) {
			let utm_source: string = QueryString.parse(history.search, {
    ...
    const validation: any = useFormik({
        ...
        onSubmit: (values) => {
            dispatch(registerUser(values, source, locationData));
        }
    });
                                            ...
                                            <div className="auth-card card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden">
                                                <Card.Body className="p-4 d-flex justify-content-between flex-column">
                                                    ...
                                                    <div className="text-center text-white-75">
                                                        <p className="mb-0">© {new Date().getFullYear()}{" "} HiroRat. Crafted with <i className="mdi mdi-heart text-danger"></i> by Valeriia</p>
                                                    </div>
                                                </Card.Body>
                                            </div>
                                        </Col>
                                            ...
                                            <Card className="mb-0 border-0 py-3 shadow-none">
                                                <Card.Body className="px-0 p-sm-5 m-lg-4">
                                                    <div className="text-center mt-2">
                                                        ...
                                                        <p className="text-muted">Get your free HiroRat account now</p>
                                                    </div>
                                                    <div className="p-2 mt-5">
                                                        <Form className="needs-validation"
                                                            ...
                                                            <div className="mb-4">
                                                                <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the HiroRat <Link href="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                            </div>
