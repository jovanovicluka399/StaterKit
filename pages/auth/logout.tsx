                                            ...
                                            <Card className="auth-card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden">
                                                <Card.Body className="p-4 d-flex justify-content-between flex-column">
                                                    ...
                                                    <div className="text-center text-white-75">
                                                        <p className="mb-0">©
                                                            {new Date().getFullYear()}{" "} HiroRat. Crafted with <i className="mdi mdi-heart text-danger"></i> by Valeriia
                                                        </p>
                                                    </div>
                                                </Card.Body>
                                            </Card>
                                            ...
                                            <Card className="mb-0 border-0 shadow-none">
                                                <Card.Body className="px-0 p-sm-5 m-lg-4 text-center">
                                                    ...
                                                    <div className="mt-4 pt-2">
                                                        ...
                                                        <p className="text-muted">Thank you for using <span className="fw-semibold">HiroRat</span> admin template</p>
                                                        <div className="mt-4">
