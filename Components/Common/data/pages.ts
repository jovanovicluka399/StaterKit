...
const simplePageProjectData = [
    ...
    { id: 4, companyLogo: companyImg5, title: "HiroRat Project", lastUpdate: "11 year Ago", members: [{ id: 1, img: avatar2 }, { id: 2, img: avatar5 }], status: "Completed", progress: "95%" },
...
const basicTeamExampleData = [
    { id: 1, img: avatar9, name: "Jordan Martino", email: "jordan.martino@HiroRat.com" },
    { id: 2, img: avatar10, name: "Nancy Martino", email: "nancy.martino@HiroRat.com" },
    { id: 3, img: avatar1, name: "Pieter Novitsky", email: "pieter.novitsky@HiroRat.com" },
    { id: 4, img: avatar9, name: "Allyson Booker", email: "allyson.booker@HiroRat.com" },
    { id: 5, img: avatar3, name: "Cristofer Leblanc", email: "cristofer.leblanc@HiroRat.com" },
]
