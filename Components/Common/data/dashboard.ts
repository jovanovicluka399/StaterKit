...
const chatmsg = [
  {
    id: 1,
    img: avatar1,
    subItem: [{ id: 1, msg: "Good morning 😊", timeStamp: "09:07 am" }],
  },
  {
    id: 2,
    subItem: [
  ...
  },
  {
    ...
    subItem: [
      ...
      { id: 2, msg: "Yeah everything is fine." },
      {
        id: 3,
  ...
  },
  {
    id: 4,
    subItem: [
      { id: 1, msg: "Wow that's great", timeStamp: "09:12 am", isRead: true },
    ],
    isSender: true,
  },
];
...
const BestSellingProductsData = [
  {
    ...
    rating: "4.7",
    price: "$64.21",
    productName: "Rockerz 550 Over Ear Bluetooth Headphones",
  },
  {
    id: 2,
    img: productImg6,
...
const stockReportData = [
  {
    ...
    productName: "Rockerz Ear Bluetooth Headphone",
    date: "16 Aug, 2022",
    amount: "$658.00",
    status: "In Stock",
    quantity: "15",
...
const monthRevenueChartData = [
  ...
  },
  {
    ...
    type: "bar",
    data: [
      89.25, 75.58, 68.74, 74.87, 77.54, 24.03, 51.24, 48.57, 12.57, 42.36,
      24.51, 36.57,
    ],
  },
  {
...
const yearRevenueChartData = [
  ...
  },
  {
    ...
    type: "bar",
    data: [
      89.25, 89.58, 68.74, 98.87, 78.54, 81.03, 51.24, 28.57, 82.57, 42.36,
      88.51, 46.57,
    ],
  },
  {
